...
** Compiling the abro example (concurrent) program
...
** Compiling the abro example (distributed memory) program
   Document is work in progress. See [[https://github.com/PRETgroup/Timetide_tests/blob/main/abro.sh][abro.sh]] and files there in
   ~Timetide_tests~ directory.
