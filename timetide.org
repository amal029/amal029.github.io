...
*** Primitive types
  We only support three signed types listed below
#+begin_src C
  int a;
  char b;
  float c;
...
*** User defined structures
   ...
   pointers are allowed. Example follows:
#+begin_src C
...
*** Variable declaration
   ...
   2. Constant variables cannot be updated, they are similar to =#define= in =C=.
...
**** Sequential loops
    ...
    3. Example of instantaneous loop follows:
	 ...
	 mut int[4] g = {0, 0, 0, 0} {	/* declare an array */
	   ...
	   g[1] = g[1] + 0;		/* update the value of the array */
	   g[2] = g[2] + 0;		/* update the value of the array */
	   g[3] = g[3] + 0;		/* update the value of the array */
	 }
       #+end_src
    ...
    4. Example of yielding (non-instantaneous) loop follows:
	 ...
	 mut int[4] X = {0, 0, 0, 0} {	/* declare array X */
       ...
       - This is different to instantaneous loop where all of X'
         elements get update in the same logical tick of the module.
